...
pub fn add_component(component_tag: String, html_data:String) -> String{
    ...
    let css_path=  String::from("./src/templates/components/") + &component_tag.to_lowercase() + &String::from(".css");
    let css_loaded = read_file(String::from(&css_path));
    let html_path = String::from("./src/templates/components/") + &component_tag.to_lowercase() + &String::from(".html");
    let html_loaded = read_file(String::from(&html_path));
